...
# File paths for benchmarking 10x
files = {
    'CSV': 'all_stocks_5yr_10x.csv',
    'Parquet_None': 'all_stocks_5yr_10x_none.parquet',
    'Parquet_Snappy': 'all_stocks_5yr_10x_snappy.parquet',
    'Parquet_Gzip': 'all_stocks_5yr_10x_gzip.parquet',
    'Parquet_Zstd': 'all_stocks_5yr_10x_zstd.parquet'
}
...
df_results.to_csv("benchmark_10x_results.csv", index=False)
